...
CPPFLAGS += -DSTM32F4xx -DSTM32F405xx -D__FPU_PRESENT=1U -D__FPU_USED=1U -DUNALIGNED_SUPPORT_DISABLE
CPPFLAGS += -DARM_MATH_CM4 -DARM_MATH_MATRIX_CHECK -DARM_MATH_ROUNDING -DARM_MATH_LOOPUNROLL
